    ...
    public class Driver
    {
        ...
        public static void EstimateLookup(int[] testSizes, string directory)
        {
            ...
            for (int j = 0; j < 2; j++)
            {
                for (int i = 0; i < 2; i++)
                {
                    ...
                    Thread lookupThread = new Thread(() => BasicResourceTest<LookUpTimingTest>(
                        LookUpTimingTest.Run,
                        testSizes,
                        localControl,
                        directory + "Lookup",
                        localGates,
        ...
        public static void EstimateArithmetic(int[] testSizes, string directory)
        {
            ...
            for (int j = 0; j < 2; j++)
            {
                for (int i = 0; i < 2; i++)
                {
                    ...
                    // Thread onesThread = new Thread(() => BasicResourceTest<CheckIfAllOneTimingTest>(
                    //     CheckIfAllOneTimingTest.Run,
                    //     testSizes,
                    //     localControl,
                    //     directory + "AllOnes",
                    //     localGates,
                    ...
                    Thread additionThread = new Thread(() => BasicResourceTest<AdditionTimingTest>(
                        AdditionTimingTest.Run,
                        testSizes,
                        localControl,
                        directory + "Addition",
                        localGates,
                    ...
                    Thread additionNoCarryThread = new Thread(() => BasicResourceTest<AdditionTimingTestNoCarry>(
                        AdditionTimingTestNoCarry.Run,
                        testSizes,
                        localControl,
                    ...
                    Thread constantAdditionThread = new Thread(() => BasicResourceTest<ConstantAdditionTimingTest>(
                        ConstantAdditionTimingTest.Run,
                        testSizes,
                        localControl,
                    ...
                    Thread greaterThanThread = new Thread(() => BasicResourceTest<GreaterThanTimingTest>(
                        GreaterThanTimingTest.Run,
                        testSizes,
                        localControl,
        ...
        public static void EstimateCheapModularArithmetic(int[] testSizes, string directory)
        {
            ...
            for (int j = 0; j < 2; j++)
            {
                for (int i = 0; i < 2; i++)
                {
                    var localControl = isControlled;
                    var localGates = allGates;
                    Thread doubleThread = new Thread(() => BasicResourceTest<ModularDblTimingTest>(
                        ModularDblTimingTest.Run,
                        testSizes,
                        localControl,
                        ...
                        false));
                    doubleThread.Start();
                    Thread additionThread = new Thread(() => BasicResourceTest<ModularAdditionTimingTest>(
                        ModularAdditionTimingTest.Run,
                        testSizes,
                        localControl,
        ...
        public static void EstimateExpensiveModularArithmetic(int[] testSizes, string directory)
        {
            ...
            for (int j = 0; j < 2; j++)
            {
                var localControl = isControlled;
                var localGates = allGates;
                Thread multiplyThread = new Thread(() => BasicResourceTest<MontgomeryMultiplicationTimingTest>(
                    MontgomeryMultiplicationTimingTest.Run,
                    testSizes,
                    localControl,
                ...
                Thread multipyNoWindowsThread = new Thread(() => BasicResourceTest<NonWindowedMontgomeryMultiplicationTimingTest>(
                    NonWindowedMontgomeryMultiplicationTimingTest.Run,
                    testSizes,
                    localControl,
                ...
                Thread squareThread = new Thread(() => BasicResourceTest<MontgomerySquareTimingTest>(
                    MontgomerySquareTimingTest.Run,
                    testSizes,
                    localControl,
                    ...
                    true));
                squareThread.Start();
                Thread invertThread = new Thread(() => BasicResourceTest<MontgomeryInversionTimingTest>(
                    MontgomeryInversionTimingTest.Run,
                    testSizes,
                    localControl,
                    ...
                    true));
                invertThread.Start();
                Thread divideThread = new Thread(() => BasicResourceTest<ModularDivisionTimingTest>(
                    ModularDivisionTimingTest.Run,
                    testSizes,
                    localControl,
        ...
        public static void EstimateEllipticCurveArithmetic(int[] testSizes, string directory)
        {
            ...
            for (int j = 0; j < 2; j++)
            {
                ...
                // Thread nonWindowedThread = new Thread(() => BasicResourceTest<EllipticCurveConstantPointAdditionTimingTest>(
                //     EllipticCurveConstantPointAdditionTimingTest.Run,
                //     testSizes,
                //     true,
                ...
                //
                // Thread windowedThread = new Thread(() => BasicResourceTest<EllipticCurveWindowedPointAdditionTimingTest>(
                //     EllipticCurveWindowedPointAdditionTimingTest.Run,
                //     testSizes,
                //     false,
                ...
                //
                // Thread lowWidthThread = new Thread(() => BasicResourceTest<EllipticCurveWindowedPointAdditionLowWidthTimingTest>(
                //     EllipticCurveWindowedPointAdditionLowWidthTimingTest.Run,
                //     testSizes,
                //     false,
                ...
                Thread signedThread = new Thread(() => BasicResourceTest<EllipticCurveSignedWindowedPointAdditionTimingTest>(
                    EllipticCurveSignedWindowedPointAdditionTimingTest.Run,
                    testSizes,
                    false,
                ...
                // Thread fixedThread = new Thread(() => BasicResourceTest<FixedEllipticCurveSignedWindowedPointAdditionTimingTest>(
                //     FixedEllipticCurveSignedWindowedPointAdditionTimingTest.Run,
                //     testSizes,
                //     false,
